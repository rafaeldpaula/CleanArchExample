...
using CleanArchExample.Domain.Specifications;
using CleanArchExample.Unit.Domain.Specifications.TestData;
using FluentAssertions;
using Xunit;

namespace CleanArchExample.Unit.Domain.Specifications
{
